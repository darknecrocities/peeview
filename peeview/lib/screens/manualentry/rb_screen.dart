...
class _RedBloodCellsScreenState extends State<RedBloodCellsScreen> {
  ...
  Future<void> _saveRBCLevel() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text("RBC level saved ✅")),
    );
    ...
    if (mounted) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => WhiteBloodCellsScreen(sessionId: widget.sessionId),
        ),
      );
    }
  }
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: _saveRBCLevel, // ✅ Save & go next
                          style: ElevatedButton.styleFrom(
